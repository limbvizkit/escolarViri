...
- For any Blade/CSS/UI work, load the `impecable` skill first.
- SDD artifacts: store proposals/specs/designs/tasks under `openspec/changes/<change>/`; archived specs live in `openspec/specs/`.
- Project context for SDD lives in `openspec/config.yaml`.
<!-- /project-conventions -->
